...
const ProductWithIngredients = ({header, description, ingredients, gramsBig, gramsSmall, productImageBig, productImageSmall, bg}) => {
    ...
    return (
        <div style={{backgroundColor: bg}} className={`px-[1rem] md:px-[3rem] 2xl:px-[9rem] py-[2rem] xl:py-[6rem] grid md:grid-cols-2 grid-cols-1 items-center md:gap-[1.5rem] lg:gap-[3rem] gap-[2rem] `}>
