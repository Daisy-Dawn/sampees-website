...
const ProductWithIngredients = ({
  ...
  return (
    <div
      ...
      className={`px-[1rem] md:px-[3rem] 2xl:px-[9rem] py-[2rem] xl:py-[6rem] grid md:grid-cols-2 grid-cols-1 items-center md:gap-[1.5rem] lg:gap-[3rem] gap-[2rem] `}
    >
      <div className='order-2 lg:order-1'>
        ...
        <Surface justify='start'>
          <h2 className='text-blossom font-poppins text-[1rem] lg:text-[1.2rem] font-semibold'>
            Ingredients:
          </h2>
        </Surface>
        <Surface justify='start'>
