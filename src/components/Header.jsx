...
const Header = () => {
  ...
  return (
    <nav
      className={`w-full h-[14dvh] sticky -top-1 left-0 z-50 bg-[#F8F9FA]  shadow-sm transition-all duration-300`}
    >
      <div className='flex justify-between items-center h-full mx-4 sm:mx-10 md:mx-12'>
        ...
        <div
          ...
          className='md:hidden flex flex-col gap-10 justify-center absolute top-0 right-0 transition-all duration-300 bg-white w-3/5 h-dvh rounded-l-[0.625rem]'
        >
