            ...
            <div className="flex justify-between items-center h-full mx-4 sm:mx-10 md:mx-12">
                ...
                <ul className=" hidden md:flex md:gap-8">
                    {navLinks.map(link => (
                        ...
                        >
                            <NavLink onClick={() => handleNavLinkClick(link.anchor)} to={link.anchor}>{link.title}</NavLink>
                        </li>
                    ))}
                </ul>
                <div className="hidden md:block">
                    <AboutButton title="Get Quote" color='white' hover='white' bgHover='#FED5D9' bg='#7E212C' action={handleNavigationToContactDesktop} />
                </div>
