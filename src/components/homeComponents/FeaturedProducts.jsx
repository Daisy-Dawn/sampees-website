  ...
  return (
    <ScrollSurface>
      <section className="flex flex-col items-center p-[1.5rem] lg:p-12 mt-24">
          <h2 className="text-[1.6rem] sm:text-[2.5rem] font-bold font-mont">Featured Products</h2>
          <h3 className="md:text-[1.4rem] text-[1.1rem] text-bark font-semibold font-mont text-center mt-4">Handpicked Selections for Unmatched Quality</h3>
