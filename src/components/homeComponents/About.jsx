...
const About = () => {
  ...
  return (
    <section className='relative flex flex-col !items-center justify-center w-full h-[40rem] p-10 md:p-12 mt-24 z-20'>
      ...
      >
        <Surface>
          <h2 className='text-[1.6rem] sm:text-[2.5rem] font-semibold font-mont'>
            About Us
          </h2>
        </Surface>
        <Surface>
        ...
        <div
          ref={scope}
          className='flex gap-8 mt-8 overflow-hidden relative z-10'
        >
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            className='bg-[#3b5998] p-1 text-white rounded-full cursor-pointer'
          >
          ...
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            className='bg-[#25D366] p-1 text-white rounded-full cursor-pointer'
          >
