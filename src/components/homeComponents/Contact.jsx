      ...
      <ScrollSurface>
        <div className='relative z-10 bg-white bg-opacity-[0.72] backdrop:blur-sm md:w-[80%] p-8 rounded-[0.625rem] flex flex-col items-start xl:flex-row md:items-center justify-between sm:gap-4 gap-2'>
          <div className='md:max-w-[75%]'>
            <h3 className='text-[1.8rem] md:text-[2rem] font-semibold font-mont text-center xl:text-start mb-2'>
              Taste the Difference
            </h3>
            <p className='text-base font-normal font-poppins text-center xl:text-start'>
              Discover our exquisite range of bakery essentials. Contact us now
              to place your order and elevate your culinary creations.
            </p>
          </div>
