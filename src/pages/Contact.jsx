...
const Contact = () => {
  ...
  return (
    <div className='md:p-12 lg:p-[1.5rem] contact-bg xl:p-[3rem] p-[1rem] '>
      <div>
        <h2 className='text-[1.6rem] sm:text-[2.5rem] font-semibold font-mont text-center'>
          Contact Us
        </h2>
        <h3 className='text-base font-semibold font-mont text-center text-blossom mt-4'>
      ...
      <div className='flex flex-col lg:grid grid-cols-2 justify-between p-0 sm:p-4 mt-4 gap-8'>
        <div className='grid grid-cols-1 order-2 lg:order-1 gap-[2rem] bg-[#F8F9FA] backdrop:blur-sm p-6 md:p-8 rounded-[0.625rem] text-black'>
          <div>
            <h3 className='font-poppins font-semibold text-lg text-center lg:text-start'>
              Contact Information
            </h3>
            <h4 className='font-poppins font-normal text-sm text-center text-blossom lg:text-start'>
              Say something to start a live chat!
            </h4>
          </div>

          <div>
            <h2 className='mb-[0.5rem] font-mont text-center md:text-left text-[1rem] font-bold text-blossom'>
              HEAD OFFICE
            </h2>
            ...
            <div className='flex flex-row lg:flex-row items-center gap-4 lg:gap-2'>
              ...
              <p className='max-w-[80%] text-left lg:text-start text-base'>
                Block D Shop 8 Almagamated Bakery Int&#39;l Market, Ogidi,
                Anambra State
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className='flex flex-row lg:flex-row items-center gap-4 lg:gap-2'>
              <MdOutlineLocationOn size={24} />
              <p className='max-w-[80%] text-left lg:text-start text-base'>
                No.1 Sampeters Close Ndiagu, Ogidi Idemili North L.G.A
              </p>
            </div>
          </div>
          ...
          <div>
            ...
            <div className='flex flex-row lg:flex-row items-center mb-4 gap-4 lg:gap-2'>
              <MdOutlineLocationOn size={24} />
              <p className='max-w-[80%] text-left lg:text-start  text-base'>
                Shop 32 Awolowo Modern Market Olosha, Mushin Lagos
              </p>
            </div>
            <div className='flex flex-row lg:flex-row items-center gap-4 lg:gap-2'>
              <MdOutlinePhoneInTalk size={24} />
          ...
          <div>
            ...
            <div className='flex flex-row lg:flex-row items-center mb-4 gap-4 lg:gap-2'>
              <MdOutlineLocationOn size={24} />
              <p className='max-w-[80%] text-left lg:text-start  text-base'>
                14B Katako Line, Sabon-geri Market, Kano
              </p>
            </div>
          ...
          <div className='flex items-center gap-4'>
            <div className='bg-black p-1 text-white rounded-full cursor-pointer  hover:bg-[#7e212c] transition-colors duration-300'>
        ...
        <div className='lg:flex-[2] order-1 lg:order-2 px-2 lg:px-0 2xl:px-8  md:px-8 pt-8'>
          ...
          >
            <div className='col-span-2 md:col-auto'>
              <label
                htmlFor='firstName'
                className='font-poppins font-medium mb-4 flex items-center gap-1'
              >
                First Name <span className='text-blossom'>*</span>
              </label>
              <input
                type='text'
                ...
                name='firstName'
                id='firstName'
                className='block contact p-2 outline-none  w-full'
              />
              {errors.firstName && (
            ...
            <div className='col-span-2 md:col-auto'>
              <label
                ...
                className='font-poppins font-medium mb-4 flex items-center gap-1'
              >
                Last Name <span className='text-blossom'>*</span>
              </label>
              <input
                type='text'
                name='lastName'
            ...
            <div className='col-span-2 md:col-auto'>
              <label
                ...
                className='font-poppins font-medium mb-4 flex items-center gap-1'
              >
                Email <span className='text-blossom'>*</span>
              </label>
              <input
                type='email'
                name='email'
            ...
            <div className='col-span-2 md:col-auto'>
              <label
                ...
                className='font-poppins font-medium mb-4 flex items-center gap-1'
              >
                Phone Number <span className='text-blossom'>*</span>
              </label>
              <input
                type='number'
                name='phoneNumber'
            ...
            <div className='col-span-2'>
              ...
              <textarea
                ...
                rows='8'
                autoCorrect='true'
                className='block resize-none contact p-2 outline-none w-full mt-4'
              ></textarea>
              {errors.message && (
