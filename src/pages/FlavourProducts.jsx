  ...
  const flavours = [
    {
      ...
      ingredients:
        'Corn Starch, Powdered Milk, Milk Flavour, Butyric Acid, Vanillin',
      grams: {
        big: '500g',
        small: '100g'
      },
    ...
    },
    {
      ...
      description:
        'Indulge in the rich and comforting taste of our De-Sunnex Mix Milk Flavor Powder. Made with a blend of premium ingredients including powdered milk, granulated sugar, and milk flour, this flavor powder is a versatile addition to your culinary creations. Our FlavourPowder captures the essence of creamy, delicious milk in a convenient powder form.',
      ingredients:
        'Corn Starch, Powdered Milk, Vanilla Flavour, Butyric Acid, Vanillin',
      grams: {
        small: '100g'
      },
      bg: '#fff',
    ...
    },
    {
      ...
      ingredients:
        'Corn Starch, Powdered Milk, Banana Flavour, Butyric Acid, Vanillin',
      grams: {
        small: '80g'
      },
      bg: '#F8F9FA',
    ...
    },
    {
      ...
      ingredients:
        'Corn Starch, Powdered Milk, Coconut Flavour, Butyric Acid, Vanillin',
      grams: {
        small: '80g'
      },
      bg: '#fff',
    ...
    },
    {
      ...
      ingredients:
        'Corn Starch, Powdered Milk, Pineapple Flavour, Butyric Acid, Vanillin',
      grams: {
        small: '80g'
      },
      bg: '#F8F9FA',
